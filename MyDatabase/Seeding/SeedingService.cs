...
namespace MyDatabase.Seeding
{
    public class SeedingService
    {
        ...
        public void SeedWhiskey()
        {
            ...
            Whiskey wh1 = new Whiskey { Name = "The Busker", Description = "The Busker Triple Cask Triple Smooth Irish Whiskey 70cl", Price = 20, PhotoUrl = "https://nutsaboutwine.ie/wp-content/uploads/2021/03/the-busker-single-malt.jpg", Category = whC1 };
