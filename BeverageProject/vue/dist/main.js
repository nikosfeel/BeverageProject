...
function patchScopedSlots (instance) {
  ...
  return function () {
    instance._u = original
        ...
        var $29066c = exports.default || module.exports;
      
      if (typeof $29066c === 'function') {
        $29066c = $29066c.options;
      }
    
        /* template */
        Object.assign($29066c, (function () {
          var render = function () {
  var _vm = this
  ...
  return _c(
    ...
    [
      _c("vue-snotify"),
      _vm._v(" "),
      _c("router-view", { key: this.$route.fullPath }),
    ],
    1
  )
}
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$29066c', $29066c);
          } else {
            api.reload('$29066c', $29066c);
          }
        }
...
},{"base64-js":"../node_modules/base64-js/index.js","ieee754":"../node_modules/ieee754/index.js","isarray":"../node_modules/isarray/index.js","buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/vue-good-table/dist/vue-good-table.esm.js":[function(require,module,exports) {
var global = arguments[3];
...
exports.default = exports.VueGoodTable = void 0;
/**
...
},{"buffer":"../node_modules/node-libs-browser/node_modules/buffer/index.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
exports.Axios = Axios;
},{"./lib/axios.js":"../node_modules/axios/lib/axios.js"}],"services/mainService.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"axios":"../node_modules/axios/index.js","../router":"router.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/Products/ProductEdit.vue":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _mainService = _interopRequireDefault(require("../../services/mainService.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
//
//
//
...
var _default = {
  props: ['editData', 'init'],
  async mounted() {
    var result = await _mainService.default.get('/api/allProducts/' + this.editData.id);
  ...
  methods: {
    async onSubmit() {
      var result = await _mainService.default.put('/api/allProducts/', this.product);
      if (result.status == 200) this.$snotify.success(`You edited ${result.data.Name}`, 'Success!');else this.$snotify.error(`For some reason you cant delete ${result.data.Name}`, 'Error!');
      await this.init();
...
exports.default = _default;
        var $d34cb8 = exports.default || module.exports;
      
      if (typeof $d34cb8 === 'function') {
        $d34cb8 = $d34cb8.options;
      }
    
        /* template */
        Object.assign($d34cb8, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "Modal",
    {
      ...
      model: {
        value: _vm.editData.showDrawer,
        callback: function ($$v) {
          _vm.$set(_vm.editData, "showDrawer", $$v)
        },
        expression: "editData.showDrawer",
      },
    },
    [
      _c("form", { attrs: { novalidate: "" } }, [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "inputEmail4" } }, [_vm._v("Name")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
            ...
            attrs: { id: "inputEmail4", type: "text", placeholder: "Name" },
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "inputAddress" } }, [_vm._v("Price €")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
            ...
            staticClass: "form-control",
            attrs: { id: "inputAddress", type: "text", placeholder: "12.90" },
        ...
        _vm._v(" "),
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "inputCity" } }, [_vm._v("PhotoUrl")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.product.PhotoUrl,
                expression: "product.PhotoUrl",
              },
            ],
            staticClass: "form-control",
            attrs: { id: "inputCity", type: "text" },
            domProps: { value: _vm.product.PhotoUrl },
            on: {
              input: function ($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.product, "PhotoUrl", $event.target.value)
              },
            },
          }),
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "row modal-footer" }, [
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d34cb8', $d34cb8);
          } else {
            api.reload('$d34cb8', $d34cb8);
          }
        }
...
},{"../../services/mainService.js":"services/mainService.js","animate.css/animate.css":"../node_modules/animate.css/animate.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/Products/ProductsTable.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    async onDelete(id) {
      ...
      var result = await _mainService.default.delete('api/AllProducts?id=' + id);
...
exports.default = _default;
        var $ea55c4 = exports.default || module.exports;
      
      if (typeof $ea55c4 === 'function') {
        $ea55c4 = $ea55c4.options;
      }
    
        /* template */
        Object.assign($ea55c4, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$ea55c4', $ea55c4);
          } else {
            api.reload('$ea55c4', $ea55c4);
          }
        }
...
},{"vue-good-table":"../node_modules/vue-good-table/dist/vue-good-table.esm.js","../../services/mainService.js":"services/mainService.js","./ProductEdit.vue":"components/Products/ProductEdit.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/Products/Products.vue":[function(require,module,exports) {
"use strict";
...
exports.default = void 0;
var _ProductsTable = _interopRequireDefault(require("./ProductsTable.vue"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
//
//
//
var _default = {
  name: 'Products',
  components: {
    ProductsTable: _ProductsTable.default
  }
};
exports.default = _default;
        var $8b2631 = exports.default || module.exports;
      
      if (typeof $8b2631 === 'function') {
        $8b2631 = $8b2631.options;
      }
    
        /* template */
        Object.assign($8b2631, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("ProductsTable")
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$8b2631', $8b2631);
          } else {
            api.reload('$8b2631', $8b2631);
          }
        }
...
},{"./ProductsTable.vue":"components/Products/ProductsTable.vue","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"router.js":[function(require,module,exports) {
"use strict";
...
var _Products = _interopRequireDefault(require("./components/Products/Products.vue"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vue-router":"../node_modules/vue-router/dist/vue-router.esm.js","./components/Products/Products.vue":"components/Products/Products.vue"}],"../node_modules/vuex/dist/vuex.esm.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","vuex":"../node_modules/vuex/dist/vuex.esm.js"}],"../node_modules/vue-snotify/vue-snotify.esm.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.SnotifyToast = exports.SnotifyStyle = exports.SnotifyPosition = void 0;
var _vue = _interopRequireDefault(require("vue"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
/**
 * vue-snotify v3.2.0
...
})(SnotifyPosition || (exports.SnotifyPosition = SnotifyPosition = {}));
...
var script = _vue.default.extend({
  props: ['toast'],
  data: function () {
    return {
...
var script$1 = _vue.default.extend({
  props: ['toast'],
  methods: {
    remove: function () {
...
var script$2 = _vue.default.extend({
  props: ['toastData'],
  components: {
...
var script$3 = _vue.default.extend({
  components: {
    Toast: Toast
  },
  data: function () {
...
var SnotifyToast = /** @class */function () {
  ...
  function SnotifyToast(id, title, body, config) {
     ...
     * @type {Vue}
     */
    this.eventEmitter = new _vue.default();
    /**
...
var _default = Plugin;
exports.default = _default;
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/vue-snotify/styles/material.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/vue-good-table/dist/vue-good-table.css":[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"components/Cart/Cart.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    async getItems() {
      var result = await _mainService.default.get("Cart/GetCartItems");
      this.products = result.data;
    },
    async buttonUp(id) {
      await _mainService.default.post("/Cart/ButtonUp?id=" + id);
      this.getItems();
    },
    async buttonDown(id) {
      await _mainService.default.post("/Cart/ButtonDown?id=" + id);
      this.getItems();
    },
    async buttonDelete(id) {
      await _mainService.default.post("/Cart/Remove?id=" + id);
      this.getItems();
    }
  },
  computed: {
...
exports.default = _default;
        var $00eff3 = exports.default || module.exports;
      
      if (typeof $00eff3 === 'function') {
        $00eff3 = $00eff3.options;
      }
    
        /* template */
        Object.assign($00eff3, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      _vm._l(_vm.products, function (product, index) {
        return _c("div", { key: index }, [
          _c(
            "div",
            { staticClass: "column full-width overflow paira-margin-bottom-4" },
            [
              _c("div", { staticClass: "row-1" }, [
                _c("img", {
                  staticClass: "img-responsive center-block",
                  attrs: { src: product.Product.PhotoUrl, alt: "" },
                }),
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row-2 text-white" }, [
                _c("p", [
                  _c("a", { attrs: { href: "#" } }, [
              ...
              _c("div", { staticClass: "row-3" }, [
                _c("p", [_vm._v(_vm._s(product.Product.Price) + " €")]),
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row-4" }, [
                _c("div", { staticClass: "quantity" }, [
                  _c("div", { staticClass: "quantity-fix display-inline-b" }, [
                    _c(
                      "button",
                      {
                        ...
                        on: {
                          click: function ($event) {
                            return _vm.buttonDown(product.Product.ProductId)
                          },
                        },
                      },
                    ...
                    _vm._v(" "),
                    _c("input", {
                      staticClass: "text-center product_quantity_text",
                    ...
                    _c(
                      "button",
                      {
                        ...
                        on: {
                          click: function ($event) {
                            return _vm.buttonUp(product.Product.ProductId)
                          },
                        },
                      },
              ...
              _c("div", { staticClass: "row-5" }, [
                _c(
                  "p",
                  {
                    staticClass: "delete-p",
                    on: {
                      click: function ($event) {
                        return _vm.buttonDelete(product.Product.ProductId)
                      },
                    },
                  },
      ...
      _c(
        "div",
        { staticClass: "col-md-12 col-sm-12 col-xs-12 pull-right text-right" },
        [
          _c("h3", { staticClass: "text-color-1" }, [
            _vm._v("Total : "),
            _c("span", [_c("b", [_vm._v(_vm._s(_vm.total) + " €")])]),
          ]),
          _vm._v(" "),
          _c(
            "a",
            {
              staticClass:
                "btn btn-success updat btn-lg margin-top-20 margin-left-20",
              attrs: { href: "/Cart/Index" },
            },
          ...
          _c(
            ...
            {
              staticClass:
                "btn btn-success btn-lg checkout margin-top-20 margin-left-20",
              attrs: { href: "/Checkout/CreateOrder" },
            },
            [_vm._v("Checkout")]
          ),
        ]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$00eff3', $00eff3);
          } else {
            api.reload('$00eff3', $00eff3);
          }
        }
...
},{"../../services/mainService.js":"services/mainService.js","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/@kouts/vue-modal/dist/vue-modal.es.js":[function(require,module,exports) {
"use strict";
...
var TargetContainer = _vue.default.extend({
...
var Portal = _vue.default.extend({
...
if (typeof window !== 'undefined' && window.Vue && window.Vue === _vue.default) {
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/@kouts/vue-modal/dist/vue-modal.css":[function(require,module,exports) {
...
var _axios = _interopRequireDefault(require("axios"));
var _vueSnotify = _interopRequireDefault(require("vue-snotify"));
require("vue-snotify/styles/material.css");
require("vue-good-table/dist/vue-good-table.css");
var _Cart = _interopRequireDefault(require("./components/Cart/Cart.vue"));
var _vueModal = _interopRequireDefault(require("@kouts/vue-modal"));
require("@kouts/vue-modal/dist/vue-modal.css");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
_vue.default.component('Modal', _vueModal.default);
...
new _vue.default({
  el: '#app-cart',
  render: h => h(_Cart.default)
});
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","./App.vue":"App.vue","./router":"router.js","./store":"store/index.js","vue-good-table":"../node_modules/vue-good-table/dist/vue-good-table.esm.js","axios":"../node_modules/axios/index.js","vue-snotify":"../node_modules/vue-snotify/vue-snotify.esm.js","vue-snotify/styles/material.css":"../node_modules/vue-snotify/styles/material.css","vue-good-table/dist/vue-good-table.css":"../node_modules/vue-good-table/dist/vue-good-table.css","./components/Cart/Cart.vue":"components/Cart/Cart.vue","@kouts/vue-modal":"../node_modules/@kouts/vue-modal/dist/vue-modal.es.js","@kouts/vue-modal/dist/vue-modal.css":"../node_modules/@kouts/vue-modal/dist/vue-modal.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
